...
<html>
	<head>
		...
		<title>Modify Profile Details</title>
	...
	<body onload="changeHashOnLoad();">
		...
		<div class="details">
			<jsp:useBean id="profile" scope="application" class="com.railwayGeneralTicketing.beans.ProfileBean"/>
				<form action="UpdateProfileController" method="get">
					<table align="center" border="0" cellpadding="7" width="50%">
						...
						<tr>	
							<td>Address:</td>
							<td><textarea name="address"><jsp:getProperty property="address" name="profile"/></textarea></td>	
						</tr>
						<tr>
							<td>Phone Number:</td>
							<td><input type="text" name="phoneNumber" value="<jsp:getProperty property="phoneNumber" name="profile"/>"/></td>
						</tr>
						<tr>
							<td><input type="submit" value="Update"/></td>
							<!-- <td><input type="reset" value="Back" onselect="ProfileController"/></td> -->
						</tr>
					</table>
				</form>	
							
				<h3>*NOTE: Click on Profile to cancel update</h3>								
			</div>	
